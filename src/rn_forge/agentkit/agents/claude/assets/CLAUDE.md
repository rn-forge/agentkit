...
- Split independent work across sub-agents and keep going while they run; intervene only if one goes off track.
...
> Dev-specific rules (code style, testing, patterns, repo structure, commands) belong in the project-level CLAUDE.md.
